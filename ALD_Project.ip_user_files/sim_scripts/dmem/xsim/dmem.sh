...
#
# Script generated by Vivado on Mon May 25 13:20:19 +0200 2026
...
#
# Usage        : dmem.sh
#                dmem.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dmem.sh [-reset_run]
#                dmem.sh [-reset_log]
#                dmem.sh [-help]
#
...
# script info
echo -e "dmem.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dmem.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot dmem xil_defaultlib.dmem -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dmem.wdb xsim.dir libdpi.so)
...
Usage: dmem.sh [-reset_log]\n\
Usage: dmem.sh [-keep_index]\n\

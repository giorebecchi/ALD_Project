...
instr_decode: process(opcode, rd, func3, func7, immed_I, immed_S, immed_B, immed_U, immed_J, rs1, rs2, rst)
   begin

      if 1 = 1 then   -- reserve structure for resets or interrupt requests
